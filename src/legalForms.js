...
// Convert LEGAL_FORMS to array of options for react-select
export const LEGAL_FORM_OPTIONS = Object.entries(LEGAL_FORMS).map(([code, name]) => ({
  value: code,
  label: `${code} - ${name}`
}));
 ...
 */
export function resolveLegalForm(code) {
